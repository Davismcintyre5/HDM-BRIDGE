...
const { getSettings, getPublicSettings, updateSetting, bulkUpdateSettings, getPaymentMethods, updatePaymentMethod, togglePaymentMethod, getSystemHealth } = require('../../controllers/admin/adminSystemController');
